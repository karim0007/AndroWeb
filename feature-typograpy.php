                ...
                <div class="paddings">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <p>Mauris <a class="tooltip_hover" data-placement="top" href="#" data-original-title="Tooltip!">tooltip</a> aliquet <a href="#">link</a> ultricies ante, non <strong>bold</strong> faucibus ante gravida sed. Sed ultrices <em>rendered as italicized text</em> pellentesque purus, vulputate volutpat ipsum hendrerit sed neque..</p>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <ul class="list icons">
                                <li><i class="icon-ok"></i> Fusce sit amet orci quis arcu vestibulum vestibulum sed ut felis.</li>
                            <li><i class="icon-coffee"></i> Phasellus in risus quis lectus iaculis vulputate id quis nisl.</li>
