                ...
                <div class="info_resalt borders">
                   <div class="container">
                        ...
                        <div class="portfolioContainer">
                            <!-- Item Work-->
                            <div class="col-sm-6 col-md-4 col-lg-3 desing">
                                <div class="item-work">
                                    <div class="hover">
                            ...
                            <!-- Item Work-->
                            <div class="col-sm-6 col-md-4 col-lg-3 development">
                                <div class="item-work">
                                    <div class="hover">
                            ...
                            <!-- Item Work-->
                            <div class="col-sm-6 col-md-4 col-lg-3 retina">
                                <div class="item-work">
                                    <div class="hover">
                ...
                <div class="info_resalt border_top">
                    <div class="container wow fadeInUp">
                        <div class="row">
                            <div class="col-md-12">
                               <!-- Sponsors Zone-->     
                                <ul class="owl-carousel carousel-sponsors" id="carousel-sponsors">
                                    <li>
